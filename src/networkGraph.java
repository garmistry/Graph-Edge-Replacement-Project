public class networkGraph {
    ...
    public static void main(String[] args){
        ...
        graph.initializeMatrix(vertices.length);
...
//        for(int i = 0; i < vertices.length; i++){
//            System.out.println(vertices[i].getVertexName());
//
//            for(int j = 0; j < vertices[i].edgeNeighborhoodSize(); j++){
//                System.out.println(vertices[i].getNeighborEdge(j));
//            }
//
//            System.out.println();
//        }
